...
<b>Фильтры</b>
    ...
    <code>suffix</code> — последние буквы в значении атрибута. Можно указать список вариантов через запятую. Варианты одного фильтра объединяются через "ИЛИ".
    ...
    Этот фильтра будет выдавать уведомления только для тикеров, у которых цена изменилась на 1.5 процента и больше.
